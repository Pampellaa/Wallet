...
urlpatterns = [
    ...
    path('income-edit/<int:income_id>/', views.IncomeEditView.as_view(), name='income_edit'),
    path('income-delete/<int:income_id>/', views.IncomeDeleteView.as_view(), name='income_delete'),
    path('expense/', views.ExpenseView.as_view(), name='expense'),
    path('expense-edit/<int:expense_id>/', views.ExpenseEditView.as_view(), name='expense_edit'),
    path('expense-delete/<int:expense_id>/', views.ExpenseDeleteView.as_view(), name='expense_delete'),
    ...
    # path('update_currencies/', views.UpdateCurrenciesView.as_view(), name='update_currencies'),
    ...
    path('transaction/edit/<int:transaction_id>/', views.TransactionEditView.as_view(), name='transaction_edit'),
    path('transaction/delete/<int:transaction_id>/', views.TransactionDeleteView.as_view(), name='transaction_delete'),
